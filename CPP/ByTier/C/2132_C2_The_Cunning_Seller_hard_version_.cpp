 ...
 *
 * This program solves an advanced version of the problem where we need to find
 * the maximum possible sum of a number's ternary digits after performing
 * exactly k operations. Each operation allows converting a digit '2' to two
 * '1's or a digit '1' to three '0's.
 *
 * Approach:
...
void solve() {
  ...
  for (int i = 0; number > 0; i++) {
    ...
    operations -=
        ternaryDigits[i]; // Each digit requires at least one operation
    number /= 3;
    totalDigits = i + 1;
  }
