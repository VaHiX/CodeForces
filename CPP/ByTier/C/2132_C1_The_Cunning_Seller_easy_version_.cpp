 ...
 * of a number. For each digit in the ternary representation, it calculates a weighted
 * sum where the weight depends on the digit's position and value.
 * 
 * Approach:
 ...
 * 3. The contribution is calculated as: digit * (3^position + 3^(position-1) * position)
 * 
