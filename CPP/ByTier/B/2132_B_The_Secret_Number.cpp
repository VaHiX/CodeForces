 ...
 *
 * This program finds all numbers 'x' such that when a digit '1' is inserted
 * between every digit of 'x', the resulting number is divisible by 'x'. For
 * example, if x=123, the resulting number would be 112131.
 *
 * Approach:
