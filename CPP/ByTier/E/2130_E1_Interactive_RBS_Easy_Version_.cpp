 ...
 * @brief Solution for Codeforces problem 2130E1 - Interactive RBS (Easy Version)
 * 
...
void solveTestCase() {
    ...
    for (int i = 1; i < sequenceLength; i += 2) {
        // Build a query that will help us determine the bracket types for positions i and i+1
        // The query is designed to encode the bracket types in the response
        cout << "? 12";
        
        // Add the pattern that will help us distinguish between different bracket combinations
        for (int j = 0; j < 3; ++j) {
