 ...
 * 4. Perform multi-source BFS from all bridge endpoints to find the closest
 * bridge to each node
 *
 ...
 * @param parentEdgeId ID of the edge used to reach current node (to avoid
 * revisiting parent)
 */
