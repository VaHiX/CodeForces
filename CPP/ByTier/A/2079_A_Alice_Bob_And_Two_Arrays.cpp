/*
 * Problem URL : https://codeforces.com/contest/2079/problem/A
...
int n, m, m_, q, k;
int aa[N], lla[N], xxa[N + 1];
int bb[M], llb[M], xxb[M + 1];
int ssa[K], ssb[K], yy_[K];
int xxa1[Q], xxb1[Q], ii[Q], jj[Q], gg[Q];
char yes[Q];
int yy[M_], yy1[M_], idx[M_];
