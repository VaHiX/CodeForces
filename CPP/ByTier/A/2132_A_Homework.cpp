 ...
 *
 * This program processes strings by appending or prepending characters from one
 * string to another based on a sequence of operations. The operations are
 * specified by a third string where 'V' means prepend and any other character
 * means append.
 *
 * Approach:
