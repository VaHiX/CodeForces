/*
 * Problem URL : https://codeforces.com/contest/375/problem/A
...
int main() {
  ...
  for (int k = 0; k < inputString.size(); k++) {
    ...
    if (currentDigit == '0') {
      ...
      if (firstOne) {
        ...
        currentMod = (10 * currentMod + (currentDigit - '0')) % 7;
      } else {
        firstOne = true;
      }
  ...
  do {
    if ((10000 * currentMod + 1000 * permDigits[0] + 100 * permDigits[1] +
         10 * permDigits[2] + permDigits[3]) %
            7 ==
        0) {
      std::cout << permDigits[0] << permDigits[1] << permDigits[2]
                << permDigits[3];
      break;
    }
