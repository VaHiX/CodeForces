// Problem: CF 2115 F2 - Gellyfish and Lycoris Radiata (Hard Version)
// https://codeforces.com/contest/2115/problem/F2

/*
Algorithm/Techniques: 
- A dynamic segment tree with lazy propagation and merging/splitting operations
- Uses a persistent-like approach with a tree structure to support efficient insertions, deletions, and queries
- Supports online processing of operations with encoded inputs and dependency on previous answers
- Time complexity is approximately O(q * log n) due to the operations on the tree
- Space complexity is O(n * log n) due to the tree nodes and auxiliary structures
