...
int main() {
  ...
  if (n >= lcm) {
    for (long k = 0; k < lcm; k++) {
      char firstMove(first[k % firstLength]),
          secondMove(second[k % secondLength]);
      if (firstMove == 'R' && secondMove == 'P') {
        ++secondScore;
      } else if (firstMove == 'R' && secondMove == 'S') {
        ++firstScore;
      } else if (firstMove == 'P' && secondMove == 'R') {
        ++firstScore;
      } else if (firstMove == 'P' && secondMove == 'S') {
        ++secondScore;
      } else if (firstMove == 'S' && secondMove == 'R') {
        ++secondScore;
