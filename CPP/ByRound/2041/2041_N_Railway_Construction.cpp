/*
 * Problem URL : https://codeforces.com/contest/2041/problem/N
...
int n, m;
int pa
    [MAX]; // ioafhaohfoierahfuoahfuorahfohaiofhaofphdasopfhoapfhdusoapfhoafhaof
int col[MAX];
vector<int> colv[MAX];
array<int, 3> w[A][A];
array<int, 3> dis[MAX];
...
/*
g++ N.cpp -o N -g -std=c++14 -Wall -Wshadow -fsanitize=undefined,address && ./N
< in.in ulimit -s unlimited
*/