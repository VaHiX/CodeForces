// Contest 1297, Problem D: Bonus Distribution
// URL: https://codeforces.com/contest/1297/problem/D
  ...
  internal object Sorter {
    ...
    fun sort(list: IntList, comparator: IntComparator) {
      quickSort(
          ...
          0,
          list.size() - 1,
          Integer.bitCount(Integer.highestOneBit(list.size()) - 1) * 5 shr 1,
          comparator,
      )
    }
