// Contest 1170, Problem I: Good Subsets
// URL: https://codeforces.com/contest/1170/problem/I
  ...
  internal class TaskI {
    ...
    fun addToTree(root: Int, rl: Int, rr: Int, at: Int, by: Int) {
      ...
      if (
          rl != rr &&
              sum[root] !=
                  ((sum[root * 2 + 1] * extraMul[root * 2 + 1].toLong() +
                          sum[root * 2 + 2] * extraMul[root * 2 + 2].toLong()) % MODULO)
                      .toInt()
      ) {
