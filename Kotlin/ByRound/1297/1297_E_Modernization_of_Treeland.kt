// Contest 1297, Problem E: Modernization of Treeland
// URL: https://codeforces.com/contest/1297/problem/E
...
object programkt {
  ...
  internal interface IntIterator {
    ...
    @Throws(NoSuchElementException::class) fun value(): Int
  ...
  internal class BidirectionalGraph
  @JvmOverloads
  constructor(vertexCount: Int, edgeCapacity: Int = vertexCount) :
      Graph(vertexCount, 2 * edgeCapacity) {
  ...
  internal open class Graph
  @JvmOverloads
  constructor(protected var vertexCount: Int, edgeCapacity: Int = vertexCount) {
