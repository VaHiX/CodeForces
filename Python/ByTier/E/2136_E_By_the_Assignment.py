# Contest 2136, Problem E: By the Assignment
...
for _ in range(t):
    ...
    for i in range(m):
        ...
        v = next(it) - 1
        eu[i] = u; ev[i] = v
        to[ptr] = v; eid[ptr] = i; nx[ptr] = head[u]; head[u] = ptr; ptr += 1
        to[ptr] = u; eid[ptr] = i; nx[ptr] = head[v]; head[v] = ptr; ptr += 1
