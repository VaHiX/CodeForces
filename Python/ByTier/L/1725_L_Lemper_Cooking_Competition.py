# Contest 1725, Problem L: Lemper Cooking Competition
# URL: https://codeforces.com/contest/1725/problem/L
...
class SortedList:
    ...
    def prev(self, it):  # added
        ...
        if it == self.begin():
            raise ValueError("{0!r} already list begin".format(it))
        pos, idx = it
    ...
    def next(self, it):  # added
        ...
        if it == self.end():
            raise ValueError("{0!r} already list end".format(it))
        pos, idx = it
        return (
            (pos, idx + 1)
