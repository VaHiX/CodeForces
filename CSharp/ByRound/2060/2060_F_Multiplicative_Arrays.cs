...
class Utility
{
    ...
    public static void DFS(Dictionary<int, List<int>> graph, int start, HashSet<int> visited = null)
    {
    ...
    public static long[][] MatrixMultiply(long[][] A, long[][] B, long mod)
    {
        ...
        for (int i = 0; i < n; i++) result[i] = new long[m];
    ...
    public static long[][] MatrixExponentiation(long[][] matrix, int n, long mod)
    {
...
class Program
{
    ...
    static void Precompute(out long[] fact, out long[] inv_fact, out long[] inv_num)
    {
