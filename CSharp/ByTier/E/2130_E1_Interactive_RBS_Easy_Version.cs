...
namespace CodeForces.Problems.Round2130.E1
{
    /// <summary>
    /// Problem: CF2130E1 - Interactive RBS (Easy Version)
    /// 
    ...
    /// - 1 ≤ n ≤ 2000 (length of the bracket sequence)
    /// - Maximum 540 queries per test case
    /// </summary>
    public class InteractiveRBSSolver
    {
        ...
        /// <summary>
        /// Initializes a new instance of the InteractiveRBSSolver class
        /// </summary>
        public InteractiveRBSSolver(TextReader input, TextWriter output)
        {
        ...
        public static void Main()
        {
            ...
            using var solver = new InteractiveRBSSolver(
                Console.In,
